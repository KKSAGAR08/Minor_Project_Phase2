...
import {
  useEscapeKeydown
} from "./chunk-5YTHO4IB.js";
import {
  Presence,
  composeEventHandlers,
  useControllableState,
  useId
} from "./chunk-3NNUOWXW.js";
import {
  useCallbackRef,
  useLayoutEffect2
...
function createSlotClone(ownerName) {
  const SlotClone = React14.forwardRef((props, forwardedRef) => {
    const { children, ...slotProps } = props;
    const childrenRef = React14.isValidElement(children) ? getElementRef(children) : void 0;
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime5.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React15.Children.map(children, (child) => (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
